...
export default class ActionSheetExample extends NavigationPage {
  ...
  showTopSeparator() {
    // 使用 Overlay.PullView + ActionSheet.Item 展示 topSeparator 枚举
    let overlayView = (
      <Overlay.PullView side='bottom' modal={false}>
        <ActionSheet.ActionSheetView.Item
          type='default'
          title='topSeparator: none'
          topSeparator='none'
          bottomSeparator='none'
          onPress={() => { alert('top: none (top item)'); Overlay.hide(this.customKey); }}
        />
        <ActionSheet.ActionSheetView.Item
          type='default'
          title='topSeparator: none'
          topSeparator='none'
          bottomSeparator='none'
          onPress={() => { alert('top: none'); Overlay.hide(this.customKey); }}
        />
        <ActionSheet.ActionSheetView.Item
          type='default'
          title='topSeparator: indent'
          topSeparator='indent'
          bottomSeparator='none'
          onPress={() => { alert('top: indent'); Overlay.hide(this.customKey); }}
        />
        <ActionSheet.ActionSheetView.Item
          type='default'
          title='topSeparator: full'
          topSeparator='full'
          bottomSeparator='none'
          onPress={() => { alert('top: full'); Overlay.hide(this.customKey); }}
        />
        <ActionSheet.ActionSheetView.Item
          type='cancel'
          title='关闭'
  ...
  showBottomSeparator() {
    // 使用 Overlay.PullView + ActionSheet.Item 展示 bottomSeparator 枚举
    let overlayView = (
      <Overlay.PullView side='bottom' modal={false}>
        <ActionSheet.ActionSheetView.Item
          type='default'
          title='bottomSeparator: none'
          topSeparator='none'
          bottomSeparator='none'
          onPress={() => { alert('bottom: none'); Overlay.hide(this.customKey); }}
        />
        <ActionSheet.ActionSheetView.Item
          type='default'
          title='bottomSeparator: indent'
          topSeparator='none'
          bottomSeparator='indent'
          onPress={() => { alert('bottom: indent'); Overlay.hide(this.customKey); }}
        />
        <ActionSheet.ActionSheetView.Item
          type='default'
          title='bottomSeparator: full'
          topSeparator='none'
          bottomSeparator='full'
          onPress={() => { alert('bottom: full'); Overlay.hide(this.customKey); }}
        />
        <ActionSheet.ActionSheetView.Item
          type='default'
          title='bottomSeparator: full'
  ...
  renderPage() {
    return (
      <ScrollView style={{ flex: 1 }}>
        ...
        <View style={{ height: 20 }} />
        <ListRow title='topSeparator 枚举' onPress={() => this.showTopSeparator()} topSeparator='full' />
        <ListRow title='bottomSeparator 枚举' onPress={() => this.showBottomSeparator()} bottomSeparator='full' />
